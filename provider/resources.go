...
import (
	...
	"github.com/BookerSoftwareInc/pulumi-ultradns/provider/pkg/version"
...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		Repository: "https://github.com/BookerSoftwareInc/pulumi-ultradns",
		...
		JavaScript: &tfbridge.JavaScriptInfo{
			PackageName: "@BookerSoftwareInc/ultradns",
		...
		Python: &tfbridge.PythonInfo{
			PackageName: "BookerSoftwareInc_ultradns",
		...
		Golang: &tfbridge.GolangInfo{
			ImportBasePath: filepath.Join(
				fmt.Sprintf("github.com/BookerSoftwareInc/pulumi-%[1]s/sdk/", mainPkg),
		...
		CSharp: &tfbridge.CSharpInfo{
			RootNamespace: "BookerSoftwareInc",
